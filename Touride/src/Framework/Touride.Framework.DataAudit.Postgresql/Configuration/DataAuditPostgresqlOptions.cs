namespace Touride.Framework.DataAudit.Postgresql.Configuration
{
    ...
    public class DataAuditPostgresqlOptions
    {
        ...
        /// </summary>
        public const string DataAuditPostgresqlOptionsSection = "Touride.Framework:DataAudit:Postgresql";
        /// <summary>
        ...
        /// Default Table.
        /// </summary>
        public virtual string AuditTableColumnNameForTableName { get; set; } = "Tablo";
        ...
        /// Default User.
        /// </summary>
        public virtual string AuditTableColumnNameForUser { get; set; } = "Kullanici";

        /// <summary>
        /// SaveChanges ve AuditLog kayıtlarının oluşturulmasının transactional olup olmayacağı bilgisi.
        /// </summary>
        public virtual bool RunAsTransactional { get; set; } = true; //TODO :CA Workaround for multiple unitOfWork support
    }
}
