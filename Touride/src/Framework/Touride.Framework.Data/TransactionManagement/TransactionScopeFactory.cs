...
namespace Touride.Framework.Data.TransactionManagement
{
    internal class TransactionScopeFactory
    {
        internal static TransactionScope Create(TransactionScopeOption scopeOption, AllowedIsolationLevel allowedIsolationLevel = AllowedIsolationLevel.ReadCommitted
            , TransactionScopeAsyncFlowOption asyncFlowOption = TransactionScopeAsyncFlowOption.Enabled)
        {
            return new TransactionScope(scopeOption, new TransactionOptions { IsolationLevel = GetIsolationLevel(allowedIsolationLevel) }, asyncFlowOption);
        }
