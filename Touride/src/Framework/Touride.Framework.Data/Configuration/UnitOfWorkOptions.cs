...
namespace Touride.Framework.Data.Configuration
{
    ...
    {
        public const string UnitOfWorkOptionsSection = "Touride.Framework:Data:UnitOfWork";
        /// <summary>
        ...
        /// <summary>
        /// GenericRepositoryde tablolarda bulunan Soft Delete propert ifade eder
        /// </summary>
        public virtual string DefaultDeletePropertyName { get; set; }

        /// <summary>
        /// GenericRepositoryde tablolarda bulunan isActive propert ifade eder
        /// </summary>
        public virtual string DefaultActivePropertyName { get; set; }
