namespace Touride.Framework.Abstractions.Caching
{
    /// <summary>
    ...
    public interface ICacheManager<T>
    {
        ...
        /// <param name="expirationMode">Cache de saklanan nesnenin yok olma zamanının hesaplanma şekli<seealso cref="CacheExpirationTypeEnum"/></param>
        /// <param name="region">Cache region.</param>
        /// <returns>Belirtilen cache item daha önce eklenmediyse true eklendiyse false</returns>
