...
namespace Product.API.Helpers
{
    public static class StartupExtensions
    {
            ...
            ApiOptions options)
        {
            ...
            builder.AddSqlServerUnitOfWork<ProductDbContext>(options, configuration);
        ...
        //{
        //    builder.AddScoped<OrderStatusChangedToAwaitingStockValidationIntegrationEventHandler>();
        //    builder.AddScoped<OrderStatusChangedToPaidIntegrationEventHandler>();
        //}
