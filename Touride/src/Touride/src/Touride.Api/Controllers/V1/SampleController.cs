...
using Touride.Application.Handler.Queries.UserQueries.GetAllDevExtremeQueries;
using Touride.Application.Handler.Queries.UserQueries.GetAllQueries;
using Touride.Application.Handler.Queries.UserQueries.GetFirstAllDefaultQueries;
using System;
