...
namespace ProjectName.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTourideApi(Configuration, new ApiOptions
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment environment, IHostingEnvironment env, ILogger<Startup> logger)
        {
